...
export function AdminRecepcionistas() {
  ...
  const recepcionistas = (data ?? []).filter((r) =>
    matchesAny([r.usuario, r.nombre, r.apellido], query),
  )
  ...
  return (
    <div>
      ...
      {loading ? (
        ...
        <EmptyState title="Sin resultados" description="Ningún recepcionista coincide con la búsqueda." />
      ) : (
